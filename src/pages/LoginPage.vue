...
<template>
  <div class="bg-slate-50 dark:bg-background-dark text-slate-900 dark:text-slate-100 overflow-hidden min-h-screen">
    <div class="flex min-h-screen w-full">
      <div class="w-full lg:w-[480px] flex flex-col justify-center px-8 lg:px-16 bg-white dark:bg-slate-900 z-10 shadow-xl">
        <div class="mb-10">
        ...
        <div class="relative z-20 flex flex-col justify-between h-full p-16 text-white">
          ...
          <div>
            ...
            <p class="text-xl text-white/80 max-w-xl leading-relaxed">
              Efficiency meets professional design. Our secure ERP system manages your entire organization's workflow with
          ...
          <div class="flex items-center justify-between">
            <div class="flex -space-x-3">
              ...
              <div class="w-10 h-10 rounded-full border-2 border-white/20 bg-slate-900/70 text-xs flex items-center justify-center font-bold">
                +12
              </div>
            </div>
