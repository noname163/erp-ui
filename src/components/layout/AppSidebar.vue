...
const items = computed<NavItem[]>(() => [
    ...
    { label: 'Payroll Runs', icon: 'payments', to: AppRoute.PAYROLL_RUNS, roles: ['HUMAN_RESOURCES'] },
    { label: 'Payroll Results', icon: 'table_view', to: AppRoute.PAYROLL_RESULTS, roles: ['HUMAN_RESOURCES'] },
